...
class JitterBuffer extends TypedEventTarget {
...
class FlowClient extends TypedEventTarget {
  constructor(server, {
    appId,
    audioBufferingMs = 10,
...
export { AddTranscriptMessageEnum, AgentAudioEvent, FlowClient, FlowIncomingMessageEvent, RecognitionDisplayDirectionEnum, RecognitionResultAttachesToEnum, RecognitionResultTypeEnum, SpeechmaticsFlowError, fetchPersonas };
